...
//             <ViroText style={styles.prodTitleText} text={product.productTitleText} width={4} height={0.5} />
...
//       objects.push(
//         <Viro3DObject key={'model' + i} source={product.objects[i]} materials={product.materials[i]} type="OBJ" />,
//       );;
//     }
...
//         animation={{ name: this.state.mainAnimation, run: this.state.runAnimation, loop: false }}>
//         <ViroImage source={products[index].previewImage} width={2.8} height={00.7} />
//         <ViroText
